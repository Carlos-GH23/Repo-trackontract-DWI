        ...
        <form className="space-y-6">
          <div className="bg-white shadow-lg rounded-xl border border-gray-200">
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              <input placeholder="Nombre *" className="w-full px-3 py-2 border border-gray-300 rounded-lg" />
              <input placeholder="Apellidos *" className="w-full px-3 py-2 border border-gray-300 rounded-lg" />
              <input placeholder="Correo Electrónico *" type="email" className="w-full px-3 py-2 border border-gray-300 rounded-lg" />
              <input placeholder="Teléfono *" type="tel" className="w-full px-3 py-2 border border-gray-300 rounded-lg" />
            </div>
          </div>
