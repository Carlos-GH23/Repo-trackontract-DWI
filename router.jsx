...
import ContratosClient from "../modules/clients/views/contratos"
import ProfileClient from "../modules/clients/views/Profile"
  ...
  <Route path="/" element={<Login />} />
        ...
        <Route element={<PrivateRoute allowedRoles={["ADMIN"]} />}>
          <Route path="/admin" element={<LayoutAdmin />}>
            ...
            <Route path="users" element={<ContratosClient />} />
            <Route path="users/edit" element={<ProfileClient />} />
          </Route>
        </Route>
